...
import make_kernels_aniano as ker
...
psf_dir = '/Volumes/fbdata3/CODE/JWST/jwst_scripts/PSF/PSF/webbpsf2p0p1/'
...
source_psf = fits.open(source_psf_path)[3]
...
factor = np.linspace(1.04, 1.5, 16)
...
for ii, ff in enumerate(factor):
    ...
    kk.write_out_kernel(outdir =psf_dir+'/kernels/' )
